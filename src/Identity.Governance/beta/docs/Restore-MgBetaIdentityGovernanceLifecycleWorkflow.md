...
### Restore (Default)
```
Restore-MgBetaIdentityGovernanceLifecycleWorkflow -WorkflowId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaIdentityGovernanceLifecycleWorkflow -InputObject <IIdentityGovernanceIdentity> [-Confirm]
