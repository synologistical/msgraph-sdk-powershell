...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.cloudprint/update-mgprint
schema: 2.0.0
---
...
### Update
```
Update-MgPrint -BodyParameter <IMicrosoftGraphPrint> [-Confirm] [-WhatIf] [<CommonParameters>]
```
