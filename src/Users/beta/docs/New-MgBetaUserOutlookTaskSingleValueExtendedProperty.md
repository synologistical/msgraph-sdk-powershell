...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetauseroutlooktasksinglevalueextendedproperty
schema: 2.0.0
---
...
```
New-MgBetaUserOutlookTaskSingleValueExtendedProperty -OutlookTaskId <String> -UserId <String>
...
### CreateViaIdentity
```
New-MgBetaUserOutlookTaskSingleValueExtendedProperty -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
