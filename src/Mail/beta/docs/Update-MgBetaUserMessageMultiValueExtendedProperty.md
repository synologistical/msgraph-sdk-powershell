...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/update-mgbetausermessagemultivalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgBetaUserMessageMultiValueExtendedProperty -MessageId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserMessageMultiValueExtendedProperty -InputObject <IMailIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
