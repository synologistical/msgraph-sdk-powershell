...
```
Update-MgBetaUserMailFolderChildFolderMultiValueExtendedProperty -MailFolderId <String>
 -MailFolderId1 <String> -MultiValueLegacyExtendedPropertyId <String> -UserId <String>
