...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/new-mgbetausermailfoldermessagemultivalueextendedproperty
schema: 2.0.0
---
...
```
New-MgBetaUserMailFolderMessageMultiValueExtendedProperty -MailFolderId <String> -MessageId <String>
...
### CreateViaIdentity
```
New-MgBetaUserMailFolderMessageMultiValueExtendedProperty -InputObject <IMailIdentity>
