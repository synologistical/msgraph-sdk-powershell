...
### Unfollow (Default)
```
Invoke-MgUnfollowDriveRoot -DriveId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgUnfollowDriveRoot -InputObject <IFilesIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
