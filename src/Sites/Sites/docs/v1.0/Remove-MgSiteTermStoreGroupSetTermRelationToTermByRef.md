...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mgsitetermstoregroupsettermrelationtotermbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSiteTermStoreGroupSetTermRelationToTermByRef -GroupId <String> -RelationId <String> -SetId <String>
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreGroupSetTermRelationToTermByRef -InputObject <ISitesIdentity> [-IfMatch <String>]
