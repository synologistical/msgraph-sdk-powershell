...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mgsitetermstoregroupsetchildrelationfromtermbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSiteTermStoreGroupSetChildRelationFromTermByRef -GroupId <String> -RelationId <String>
...
### DeleteViaIdentity
```
Remove-MgSiteTermStoreGroupSetChildRelationFromTermByRef -InputObject <ISitesIdentity> [-IfMatch <String>]
