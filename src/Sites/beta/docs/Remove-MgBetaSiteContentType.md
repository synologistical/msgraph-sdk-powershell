...
### Delete (Default)
```
Remove-MgBetaSiteContentType -ContentTypeId <String> -SiteId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSiteContentType -InputObject <ISitesIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
