...
### Update
```
Update-MgCompliance -BodyParameter <IMicrosoftGraphCompliance1> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphCompliance1
...
BODYPARAMETER <IMicrosoftGraphCompliance1>: compliance
