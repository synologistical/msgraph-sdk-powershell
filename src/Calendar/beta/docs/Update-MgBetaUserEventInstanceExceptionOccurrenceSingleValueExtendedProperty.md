...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/update-mgbetausereventinstanceexceptionoccurrencesinglevalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgBetaUserEventInstanceExceptionOccurrenceSingleValueExtendedProperty -EventId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserEventInstanceExceptionOccurrenceSingleValueExtendedProperty -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
