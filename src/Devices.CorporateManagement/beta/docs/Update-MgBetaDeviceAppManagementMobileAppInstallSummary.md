...
Update-MgBetaDeviceAppManagementMobileAppInstallSummary -MobileAppId <String>
 ...
 [-PendingInstallDeviceCount <Int32>] [-PendingInstallUserCount <Int32>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgBetaDeviceAppManagementMobileAppInstallSummary -MobileAppId <String>
 -BodyParameter <IMicrosoftGraphMobileAppInstallSummary> [-Confirm] [-WhatIf] [<CommonParameters>]
```
