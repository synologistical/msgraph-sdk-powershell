...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/update-mgbetagroupthreadpostinreplytomultivalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgBetaGroupThreadPostInReplyToMultiValueExtendedProperty -ConversationThreadId <String>
 -GroupId <String> -MultiValueLegacyExtendedPropertyId <String> -PostId <String>
...
### UpdateViaIdentity
```
Update-MgBetaGroupThreadPostInReplyToMultiValueExtendedProperty -InputObject <IGroupsIdentity>
 -BodyParameter <IMicrosoftGraphMultiValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
