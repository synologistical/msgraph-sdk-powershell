    ...
    public static class ConditionalAssemblyProvider
    {
        ...
        public static void Initialize(string rootPath, IConditionalAssemblyContext context)
        {
            ...
            _assemblies = new List<IConditionalAssembly>()
            {
                ...
                #region AssemblyList
                CreateAssembly("net6.0", "Azure.Core", "1.25.0.0").WithPowerShellCore(),
                CreateAssembly("net6.0", "Microsoft.Identity.Client", "4.51.0.0").WithPowerShellCore(),
                CreateAssembly("net6.0", "Microsoft.Identity.Client.Extensions.Msal", "2.27.0.0").WithPowerShellCore(),
                ...
                CreateAssembly("netstandard2.0", "Microsoft.Graph.Core", "2.0.11.0"),
                ...
                CreateAssembly("netstandard2.0", "Microsoft.IdentityModel.Abstractions", "6.22.0.0"),
                ...
                CreateAssembly("netfx", "Microsoft.Identity.Client", "4.51.0.0").WithWindowsPowerShell(),
                CreateAssembly("netfx", "Microsoft.Identity.Client.Extensions.Msal", "2.27.0.0").WithWindowsPowerShell(),
                ...
                CreateAssembly("netfx", "System.Text.Json", "4.0.1.2").WithWindowsPowerShell(),
