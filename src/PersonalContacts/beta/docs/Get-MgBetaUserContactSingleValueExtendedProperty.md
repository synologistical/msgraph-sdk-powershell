...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactsinglevalueextendedproperty
schema: 2.0.0
---

# Get-MgBetaUserContactSingleValueExtendedProperty
...
### List (Default)
```
Get-MgBetaUserContactSingleValueExtendedProperty -ContactId <String> -UserId <String>
...
### Get
```
Get-MgBetaUserContactSingleValueExtendedProperty -ContactId <String>
...
### GetViaIdentity
```
Get-MgBetaUserContactSingleValueExtendedProperty -InputObject <IPersonalContactsIdentity>
