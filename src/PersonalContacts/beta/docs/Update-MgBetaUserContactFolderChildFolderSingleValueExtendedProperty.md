...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/update-mgbetausercontactfolderchildfoldersinglevalueextendedproperty
schema: 2.0.0
---
...
```
Update-MgBetaUserContactFolderChildFolderSingleValueExtendedProperty -ContactFolderId <String>
...
### UpdateViaIdentity
```
Update-MgBetaUserContactFolderChildFolderSingleValueExtendedProperty -InputObject <IPersonalContactsIdentity>
 -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-Confirm] [-WhatIf] [<CommonParameters>]
```
