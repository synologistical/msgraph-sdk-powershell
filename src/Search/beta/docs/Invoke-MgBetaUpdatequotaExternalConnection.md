...
Invoke-MgBetaUpdatequotaExternalConnection -ExternalConnectionId <String>
 -Body <IMicrosoftGraphExternalConnectorsConnectionQuota> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Updatequota, UpdatequotaExpanded
Aliases:
...
Parameter Sets: UpdatequotaViaIdentity, UpdatequotaViaIdentityExpanded
Aliases:
