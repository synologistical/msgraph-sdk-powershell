...
### Update
```
Update-MgTeamChannel -ChannelId <String> -TeamId <String> -BodyParameter <IMicrosoftGraphChannel> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgTeamChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
