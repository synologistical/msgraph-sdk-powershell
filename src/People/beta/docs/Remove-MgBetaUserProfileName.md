...
### Delete (Default)
```
Remove-MgBetaUserProfileName -PersonNameId <String> -UserId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfileName -InputObject <IPeopleIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
